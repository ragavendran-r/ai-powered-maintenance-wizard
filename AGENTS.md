...
- Added `scripts/run-local-stack.sh` as the common local runner for Docker NATS JetStream, streaming-enabled FastAPI, and Vite, plus README/progress documentation.
