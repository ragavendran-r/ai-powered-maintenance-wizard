...
- Merged PR #7 before new work, then moved the complete ingestion section into a dedicated left-nav Ingestion view while keeping dashboard diagnosis and recommendation workflows separate.
