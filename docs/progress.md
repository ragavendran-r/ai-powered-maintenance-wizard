...
- Updated README, architecture, RAG+PEFT+NATS design, and goal tracker to reflect the worker and artifact registry. Remaining G-016 work is external trainer/orchestrator execution, object storage, adapter promotion/rollback gates, production embeddings/Qdrant migration controls, and Postgres migration.
